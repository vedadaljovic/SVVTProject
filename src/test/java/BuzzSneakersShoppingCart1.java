...
public class BuzzSneakersShoppingCart1 {
    ...
    public void testShoppingCart() throws InterruptedException {
        ...
        WebElement quantity = wait.until(ExpectedConditions.presenceOfElementLocated(By.id("quantity_1")));
        assertEquals("3", quantity.getAttribute("value"), "The quantity should be updated to 3.");
